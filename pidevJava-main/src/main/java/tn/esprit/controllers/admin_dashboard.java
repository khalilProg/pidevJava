...
public class admin_dashboard {
    ...
    // ⬅️ YOUR MODULE NAVIGATION ACTIONS ADDED HERE!
    @FXML
    void handleNavigateDossierMedClick(MouseEvent event) {
        navigateTo(event, "/DossierMedList.fxml");
    }

    @FXML
    void handleNavigateDonationsClick(MouseEvent event) {
        navigateTo(event, "/DonationList.fxml");
    }
    // ⬅️ ----------------------------------------------
