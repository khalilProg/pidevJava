...
public class AgentBanqueTransfertController {
    ...
    public void initialize() {
        ...
        // Setup ComboBox
        comboStatusFilter.getItems().addAll("Tous les statuts", "En attente", "En cours", "Reçu", "Refusé", "Annulé");
    ...
    private void updateFilters() {
        ...
        filteredData.setPredicate(transfert -> {
            ...
            if (statusFilter != null) {
                if (statusFilter.equals("En attente")) mappedStatus = "EN_ATTENTE";
                else if (statusFilter.equals("En cours")) mappedStatus = "EN_COURS";
                else if (statusFilter.equals("Reçu")) mappedStatus = "RECU";
                else if (statusFilter.equals("Refusé")) mappedStatus = "REFUSEE";
                else if (statusFilter.equals("Annulé")) mappedStatus = "ANNULE";
            }
            // Filter by Status
    ...
    private javafx.scene.Node createTransfertCard(Transfert t) {
        ...
        if (isPending) {
            ...
            btnConfirm.setOnAction(e -> handleUpdateStatus(t, "RECU"));
            ...
            btnCancel.setOnAction(e -> handleUpdateStatus(t, "ANNULE"));
    ...
    private void handleUpdateStatus(Transfert t, String newStatus) {
        try {
            ...
            if ("RECU".equalsIgnoreCase(newStatus)) {
