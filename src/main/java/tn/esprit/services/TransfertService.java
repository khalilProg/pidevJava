...
public class TransfertService implements IGeneralService<Transfert>{
    ...
    public List<Transfert> recuperer() throws SQLException {
        String sql = "SELECT t.*, d.type_sang FROM transfert t LEFT JOIN demande d ON t.demande_id = d.id";
        ...
        while (rs.next()) {
            ...
            demande.setTypeSang(rs.getString("type_sang")); // Récupéré via le JOIN
