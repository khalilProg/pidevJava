...
import tn.esprit.tools.SymfonyPasswordEncoder;
...
public class register {
    ...
    void handleRegister(ActionEvent event) {
        ...
        String hashedPassword = SymfonyPasswordEncoder.hash(password);
        User newUser = new User(email, nom, prenom, hashedPassword, "client", tel);
                ...
                javafx.application.Platform.runLater(() -> {
                    try {
                        ...
                        if (u == null) {
                            ...
                            String randomPassword = SymfonyPasswordEncoder.hash(java.util.UUID.randomUUID().toString());
