...
public class FrontMedicalController extends BaseFront implements Initializable {

    @FXML private StackPane rootPane;
    @FXML private Label bloodLabel, ageLabel, genderLabel, heightLabel, weightLabel;
    ...
    // Removed redundant goToAccueil and goToMyDonations
}