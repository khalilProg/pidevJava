...
public class AdminSidebarController {
    ...
    @FXML private Button btnDossierMed;
    ...
    // ⬅️ YOUR MODULE NAVIGATION METHODS ADDED HERE
    @FXML
    void handleNavigateDossierMed(ActionEvent event) {
        navigateTo(event, "/DossierMedList.fxml"); // Ensure this string exactly matches your FXML filename
    }

    @FXML
    void handleNavigateDonations(ActionEvent event) {
        navigateTo(event, "/DonationList.fxml");   // Ensure this string exactly matches your FXML filename
    }
    ...
    private void updateActiveNavigation() {
        // ⬅️ YOUR BUTTONS REGISTERED HERE TO ALLOW STYLE/HOVER EFFECTS TO APPLY
    ...
    private Button getActiveButton() {
        ...
        // ⬅️ YOUR LOGIC TRIGGERED FOR BUTTON ACTIVE HIGHLIGHTS
        if (currentPath.contains("DossierMed")) return btnDossierMed;
        if (currentPath.contains("Donation")) return btnDonations;
