...
public class FrontDonationController extends BaseFront implements Initializable {
    ...
    // Inherited from BaseFront: navMenuPanel, menuOverlay
    ...
    // Removed redundant handleThemeToggle and goToAccueil
    ...
    // Removed redundant toggleMenu, goToAccueil, goToHistorique, goToMyDonations, goToMyProfile
}